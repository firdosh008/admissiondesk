              ...
              {FAQS.map((f, i) => (
                ...
                >
                  <summary className="flex items-start justify-between gap-6 cursor-pointer list-none">
                    <h3 className="font-display text-xl md:text-2xl text-[color:var(--forest-deep)] leading-snug pr-4 group-hover:text-[color:var(--moss)] transition-colors">
                      {f.q}
                    </h3>
                    <span className="mt-1 flex-none inline-flex items-center justify-center w-9 h-9 rounded-full border border-[color:var(--rule)] text-[color:var(--forest-deep)] group-open:rotate-45 transition-transform duration-300 group-hover:border-[color:var(--gold)] group-hover:text-[color:var(--gold-deep)]">
                      <svg
                        width="14"
                        height="14"
                        viewBox="0 0 24 24"
