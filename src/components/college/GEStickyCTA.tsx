  ...
  return (
    ...
    >
      <button
        ...
        className="btn-primary shadow-[0_4px_24px_-8px_rgba(8,36,32,0.5)] text-sm py-3 px-3.5 sm:px-5"
      >
      ...
      <a
        href={`https://wa.me/${PAGE_CONTACTS.graphicEra.whatsapp}?text=${encodeURIComponent(
          "Hi, I'd like free counselling for Graphic Era University admissions."
        )}`}
        className="btn-whatsapp shadow-[0_4px_24px_-8px_rgba(31,122,58,0.5)] text-sm py-3 px-3.5 sm:px-5"
        target="_blank"
        rel="noopener noreferrer"
        data-event="whatsapp_sticky_ge"
      >
