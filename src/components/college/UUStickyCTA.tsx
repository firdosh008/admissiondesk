...
export function UUStickyCTA() {
  ...
  return (
    ...
    >
      ...
      <a
        href={`https://wa.me/${PAGE_CONTACTS.uttaranchal.whatsapp}?text=${encodeURIComponent(
          "Hi, I'd like free counselling for Uttaranchal University admissions."
        )}`}
        className="btn-whatsapp shadow-[0_4px_24px_-8px_rgba(31,122,58,0.5)] text-sm py-3 px-3.5 sm:px-5"
        target="_blank"
        rel="noopener noreferrer"
        data-event="whatsapp_sticky_uu"
      >
