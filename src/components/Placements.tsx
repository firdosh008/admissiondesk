...
export function Placements() {
  return (
    <section id="placements" className="section-dark">
      <div className="container-x py-12 md:py-24 lg:py-32 relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 md:gap-10 lg:gap-14 items-start">
          {/* ── Left: Narrative ── */}
          <div className="lg:col-span-5">
            <p className="eyebrow text-[color:var(--gold-soft)]">
              Where graduates go
            </p>
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl mt-4 leading-[1.02] text-[color:var(--ivory)]">
              Hired at the
              <br />
            ...
            <div className="mt-6 md:mt-10 space-y-1">
              {[
                ...
                <div
                  key={m.label}
                  className="flex items-baseline justify-between py-3 md:py-4 border-b border-[color:var(--ivory)]/10 gap-4"
                >
                  <span className="text-sm text-[color:var(--ivory)]/65">
                    {m.label}
                  </span>
                  <span className="font-display text-xl md:text-2xl text-[color:var(--gold-soft)] shrink-0">
                    {m.value}
                  </span>
                </div>
              ))}
          ...
          <div className="lg:col-span-7">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {TOP_RECRUITERS.map((r) => (
                <div
                  key={r}
                  className="card-dark py-3 px-3 sm:py-4 sm:px-4 text-center hover:bg-[color:var(--ivory)]/10 transition-colors"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                {ADMITS.map((a) => (
                  <div
                    ...
                    className="card-dark px-3 py-3 sm:px-5 sm:py-4 hover:bg-[color:var(--ivory)]/10 transition-colors"
                  >
                    <p className="font-display text-lg md:text-xl leading-none text-[color:var(--ivory)]">
                      {a.initials}
                    </p>
